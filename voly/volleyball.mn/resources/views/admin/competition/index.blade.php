    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Тэмцээний жагсаалт</li>
            </ul>
            <h1 class="page-header mb-0">Тэмцээний жагсаалт</h1>
        </div>
        <div class="ml-auto">
            <a href="{{ route('Competition.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle fa-fw mr-1"></i>Тэмцээн нэмэх</a>
        </div>
    </div>
    <div class="container">
        <div class="row">
    ...
    <div class="card" style="padding: 25px;">
        <div class="tab-content p-4">
            <div class="tab-pane fade show active" id="allTab">
                <form action="{{ route('Competition.index') }}" method="get">
                @csrf
                ...
                <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0 border-top-0 pt-0 pb-2">Тоглолтийн нэр</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <label class="btn btn-primary">{{ $comp->create_date }}</label>
                                </td>
                                <td class="align-middle" data-bs-toggle="tooltip" data-bs-placement="top">
                                    {{$comp->result()}}
                                </td>
