    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Тоглогчидын жагсаалт</li>
            </ul>
            <h1 class="page-header mb-0">Тоглогчидын жагсаалт</h1>
        </div>
        <div class="ml-auto">
            <a href="{{ route('Player.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle fa-fw mr-1"></i>Тоглогч нэмэх</a>
        </div>
    </div>
    <div class="container">
        <div class="row">
                ...
                <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0 border-top-0 pt-0 pb-2">Тоглогчийн дугаар</th>
                                <th class="border-bottom-0 border-top-0 pt-0 pb-2">Тоглогчийн нэр</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td  class="align-middle"> {{$player->huviin_number}}</td>
                                <td class="align-middle">
                                    {{$player->frist_name}}
                                </td>
                                <td class="align-middle" data-bs-toggle="tooltip" data-bs-placement="top">
                                    <div class="img" > <img style="height: 50px;" src="{{asset('app/'.$player->image)}}" alt=""></div>

                                </td>
                                <td><a href="{{route('Player.edit',$player->id)}}" class="btn btn-waring"> <i class="fa fa-edit"></i> </a></td>
                            ...
                            @if(count($players) == 0)
                                <tr>
                                    <td colspan="8">
                                        Одоогоор Тоглогч байхгүй байна.
                                    </td>
                                </tr>
                            @endif
                        </tbody>
