...
<div id="content" class="app-content">
    <div class="d-flex align-items-center mb-3">
        <div>
            ...
            <h1 class="page-header mb-0">Мэдээ нэмэх</h1>
        </div>
        <div class="ml-auto">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" required="" placeholder="News title" value="@if(Session('backtitle')){{ Session('backtitle') }} @endif">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" id="" class="form-control">
                                @foreach($categories as $category)
                                    <option value="{{ $category->category }}" @if(Session('backcategory')) @if(Session('backcategory') == $category->category) selected="" @endif @endif>{{ $category->category }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
