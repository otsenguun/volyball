...
<div id="content" class="app-content">
    <div class="d-flex align-items-center mb-3">
        <div>
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/admin/cooperation') }}">Хамтран ажиллагч байгууллагын жагсаалт</a></li>
                <li class="breadcrumb-item active">Хамтран ажиллагч байгууллага нэмэх</li>
            </ul>
            <h1 class="page-header mb-0">Хамтран ажиллагч байгууллага нэмэх</h1>
        </div>
        <div class="ml-auto">
            <a href="{{ url('/admin/cooperation') }}" class="btn btn-primary"><i class="fa fa-plus-circle fa-fw mr-1"></i>Буцах</a>
        </div>
    </div>
    <div class="container">
        <div class="row">
    ...
    <div class="card" style="padding: 25px;">
        <div class="container">
            <form action="{{ url('/admin/cooperation/add') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="">Байгууллага</label>
                            <input type="text" name="company" class="form-control" required="" placeholder="Company title" value="@if(Session('backcompany')){{ Session('backcompany') }} @endif">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ url('/admin/cooperation/add') }}" class="btn btn-warning">Reset хийх</a>
                        </div>
                    </div>
                </div>
            </form>
