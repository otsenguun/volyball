    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Хамтран ажиллагч байгууллагууд</li>
            </ul>
            <h1 class="page-header mb-0">Хамтран ажиллагч байгууллагууд</h1>
        </div>
        <div class="ml-auto">
            <a href="{{ url('/admin/cooperation/add') }}" class="btn btn-primary"><i class="fa fa-plus-circle fa-fw mr-1"></i>Хамтран ажиллагч байгууллага нэмэх</a>
        </div>
    </div>
    <div class="container">
        <div class="row">
        ...
        <div class="tab-content p-4">
            <div class="tab-pane fade show active" id="allTab">
                ...
                <table class="table table-hover text-nowrap">
                    <form class="checkboxform" action="{{ url('/admin/cooperation/dropbox') }}" method="post">
                    @csrf
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0 border-top-0 pt-0 pb-2">Байгууллага</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="width-10 align-middle">
                                    <input type="checkbox" class="selectbox" name="logo_id[]" value="{{ $logo->id }}" id="">
                                </td>
                                <td class="align-middle">{{ $cNumber+=1 }}</td>
                                <td class="align-middle" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $logo->title }}">
                                    {{ Str::limit($logo->company, 50) }}
                                </td>
                                <td class="align-middle">
                                    <img src="{{ url('/'.$logo->logo) }}" alt="Volleyball.mn" style="width: 80px;">
                                </td>
                                <td class="align-middle">{{ $logo->updated_at->diffForHumans() }}</td>
                                <td class="actioned-menu">
                                    <a href="{{ url('/admin/cooperation/drop/'.$logo->id) }}">
                                        <i class="fa fa-trash-alt"></i>
                                    </a>
                                </td>
                            </tr>
                            @endforeach
                            @if($countCooperation == 0)
                                <tr>
                                    <td colspan="8">
                                        Одоогоор хамтран ажиллагч байгууллага бүртгэлгүй байна.
                                    </td>
                                </tr>
                            @endif
                        </tbody>
